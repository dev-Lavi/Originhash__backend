...
const registerUser = async (req, res) => {
  ...
  try {
    ...
    const verificationLink = `https://originhash-frontend.vercel.app/verify/${token}`;
...
const forgotPassword = async (req, res) => {
  ...
  const resetLink = `https://originhash-frontend.vercel.app/reset-password/${resetToken}`;
